"""
Django settings for qr_access_backend project.
Production-grade configuration with MongoDB, JWT, and CORS support.
"""
...
# Media files (User uploads, QR codes)
MEDIA_URL = 'media/'
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': False,  # Disable to avoid ObjectId issues
    'BLACKLIST_AFTER_ROTATION': False,  # Disable blacklisting
    'UPDATE_LAST_LOGIN': False,  # Disable to avoid DB queries
